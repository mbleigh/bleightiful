	<div id="sidebar">
		<ul>
			...
			<li>
		    <h3>About Mister Bleigh</h3>
		    <div class='box'><strong>Michael Bleigh</strong> is a Rubyist, designer, speaker, and currently Creative Director at Intridea, Inc.</div>
		  </li>
			...
			<li>
			  <h3>Search</h3>
				<div class='box'><?php include (TEMPLATEPATH . '/searchform.php'); ?></div>
			</li>
